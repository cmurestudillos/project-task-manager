...
contextBridge.exposeInMainWorld('api', {
  ...
  updateSubtask: (projectId, taskId, subtaskId, subtask) => ipcRenderer.invoke('update-subtask', { projectId, taskId, subtaskId, updatedSubtask: subtask }),
  deleteSubtask: (projectId, taskId, subtaskId) => ipcRenderer.invoke('delete-subtask', { projectId, taskId, subtaskId }),
});